...
import { autoscout24Url, njuskaloUrl } from './outbound.js'
...
test('model bez poznatog ID-a ne ulazi u link', () => {
  const url = new URL(njuskaloUrl(criteria, models))
  assert.equal(url.searchParams.get('vehicleIds').includes('undefined'), false)
})
